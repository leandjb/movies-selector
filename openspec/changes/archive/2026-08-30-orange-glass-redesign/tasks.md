...
- [x] 9.3 Manual smoke in a browser: load `index.html`, paste a link, import a gist, vote to full allocation, reveal the winner, clear all — confirm toasts, pill, progress bar, and amber glass throughout
